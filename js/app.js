...
$(document).ready(function () {
    $('.welcome__parallax-list>li').addClass('layer');
    $('.welcome__parallax-list').parallax();
})

let myImageSlider = new Swiper('.aboutus-slider', {
...
//=================
//Menu
let iconMenu = document.querySelector(".header__burger-menu");
if (iconMenu != null) {
	let delay = 500;
